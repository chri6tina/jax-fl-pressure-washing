  ...
  return (
    <AdminProtected>
      <div className="min-h-screen bg-gray-50 py-8">
        {/* Notification Script - This will track page visits and show notifications */}
        <script
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 pt-4">
                    ...
                    <button
                      ...
                      className="w-full bg-orange-600 text-white py-2 px-4 rounded-lg text-sm font-medium hover:bg-orange-700"
                    >
