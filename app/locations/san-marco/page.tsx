    ...
    <div className="min-h-screen bg-neutral-white">
        ...
        <div className="relative z-10 container-custom text-center text-neutral-white px-4">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-semibold">San Marco, Jacksonville FL</span>
            </motion.div>
            ...
            >
              ...
              <span className="block text-accent">San Marco</span>
            ...
            >
              Historic building preservation specialists serving 
              <span className="text-accent font-semibold"> San Marco Square</span>, 
              <span className="text-accent font-semibold"> Historic District</span>, 
              <span className="text-accent font-semibold"> Business District</span>, and 
              <span className="text-accent font-semibold"> Waterfront</span>.
            </motion.p>
            ...
            >
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/25 hover:bg-white/20 transition-all duration-300">
                <div className="text-3xl md:text-4xl font-bold text-accent mb-2">25+ Years</div>
              ...
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/25 hover:bg-white/20 transition-all duration-300">
                ...
                <div className="text-white/90 text-sm md:text-base">San Marco Properties</div>
              </div>
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/25 hover:bg-white/20 transition-all duration-300">
            ...
            >
              ...
              <div className="flex items-center space-x-3 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-full border border-white/25">
                <FaCheckCircle className="text-accent-eco text-lg" />
                <span className="font-semibold">Cultural Landmark Care</span>
              </div>
              <div className="flex items-center space-x-3 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-full border border-white/25">
                <FaCheckCircle className="text-accent-eco text-lg" />
            ...
            >
              <p className="text-white/80 text-sm mb-4">Trusted by San Marco Residents for Over 25 Years</p>
              <div className="flex justify-center space-x-6 text-white/60">
                <span className="text-sm">✓ Licensed & Insured</span>
                <span className="text-sm">✓ Historic Preservation</span>
                <span className="text-sm">✓ Commercial Expertise</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-neutral-text mb-6">
              San Marco Pressure Washing Excellence
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              As the trusted pressure washing company serving San Marco, we understand the unique demands of historic and urban properties. 
              Our preservation-focused approach combines professional service with the care and attention that San Marco's architectural heritage deserves.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            >
              <h3 className="text-3xl font-bold text-neutral-text mb-6">
                Why San Marco Needs Professional Pressure Washing
              </h3>
              <div className="space-y-4 text-lg text-gray-700">
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-accent rounded-full mt-3 flex-shrink-0"></div>
                  <p><strong>Historic Architecture:</strong> San Marco's historic buildings require gentle, preservation-focused cleaning that protects original materials and architectural details.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="text-accent rounded-full mt-3 flex-shrink-0"></div>
                  <p><strong>Urban Environment:</strong> City pollution, traffic residue, and urban grime accumulate faster on San Marco's commercial and residential properties.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-accent rounded-full mt-3 flex-shrink-0"></div>
                  <p><strong>Cultural Significance:</strong> As Jacksonville's historic heart, San Marco properties require service that respects and enhances their cultural importance.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-accent rounded-full mt-3 flex-shrink-0"></div>
                  <p><strong>Mixed-Use Properties:</strong> San Marco's blend of residential and commercial properties requires versatile cleaning solutions and scheduling flexibility.</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <h4 className="text-2xl font-bold mb-6">San Marco Quick Facts</h4>
              <div className="space-y-4 text-lg">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">Victorian/Classical</span>
                </div>
                <div className="flex justify-between">
                  <span>Landmarks:</span>
                  <span className="font-semibold">20+ Cultural Sites</span>
                </div>
                <div className="flex justify-between">
          ...
          >
            <h3 className="text-3xl font-bold text-neutral-text mb-8">
              San Marco Service Areas We Cover
            </h3>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              San Marco is Jacksonville's historic heart, known for its beautiful architecture, cultural landmarks, and vibrant community. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mb-4 mx-auto">
                <FaLandmark className="text-2xl text-primary" />
              </div>
            ...
            >
              ...
              <p className="text-gray-600">
                San Marco's urban environment requires specialized approaches for commercial and residential properties.
              </p>
            </motion.div>
            ...
            >
              <div className="w-16 h-16 bg-accent-eco/10 rounded-full flex items-center justify-center mb-4 mx-auto">
                <FaHistory className="text-2xl text-accent-eco" />
              </div>
              <h3 className="text-xl font-semibold text-neutral-text mb-3">Cultural Heritage Focus</h3>
              <p className="text-gray-600">
                We respect San Marco's rich history and provide service that enhances its architectural beauty.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Specialized cleaning services for San Marco's historic buildings and urban properties
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              From the historic district to the modern developments, we cover all of San Marco
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              'San Marco Entertainment District',
              'San Marco Residential',
              'San Marco Commercial'
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Don't just take our word for it - hear from our satisfied San Marco clients
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                location: "San Marco Historic District",
                rating: 5,
              ...
              },
              {
                ...
                rating: 5,
                text: "Our commercial building in San Marco Square needed professional cleaning that wouldn't disrupt our business. The team was professional, efficient, and respectful of our historic building. Highly recommend for any San Marco property!",
                service: "Commercial Building Washing"
              },
              {
                name: "Margaret Thompson",
                location: "San Marco Cultural District",
                rating: 5,
                text: "Living in San Marco means being part of Jacksonville's cultural heritage. These professionals understand that and provide service that enhances our neighborhood's beauty while preserving its historic character.",
      ...
      <section className="py-20 bg-gray-50">
        <div className="container-custom">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-neutral-text mb-6">
              San Marco Pressure Washing FAQ
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Common questions about pressure washing services in San Marco, Jacksonville
            </p>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            {[
              ...
              {
                question: "Do you offer commercial pressure washing in San Marco?",
                answer: "Absolutely! We provide comprehensive commercial pressure washing services for San Marco's business district, including storefronts, office buildings, and mixed-use properties. We work around your business hours to minimize disruption."
              },
              {
                question: "What makes San Marco properties different for pressure washing?",
                answer: "San Marco's historic architecture, urban environment, and cultural significance require specialized care. We understand the unique challenges of preserving historic buildings while maintaining their beauty in an urban setting."
              },
              {
                question: "How long does a typical San Marco property cleaning take?",
                answer: "Most San Marco properties take 3-6 hours depending on size, historic features, and services needed. Historic buildings require extra care and attention to detail, which we factor into our timeline estimates."
              },
              {
                question: "Do you offer preservation-focused maintenance packages?",
                answer: "Yes! We offer specialized maintenance packages for San Marco's historic properties, including regular cleaning schedules, preservation treatments, and priority booking for cultural landmark properties."
              },
              {
                question: "What areas of my San Marco property do you clean?",
        ...
        <div className="container-custom text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Ready to Preserve Your San Marco Property?
            </h2>
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Join our satisfied San Marco clients who trust us to maintain their historic and urban properties.
            </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Jax FL Pressure Washing - San Marco Jacksonville",
            "description": "Historic building pressure washing services in San Marco, Jacksonville FL. Urban property specialists for cultural landmarks and architectural preservation.",
