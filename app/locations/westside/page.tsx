    ...
    <div className="min-h-screen bg-neutral-white">
        ...
        <div className="relative z-10 container-custom text-center text-neutral-white px-4">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-semibold">Westside, Jacksonville FL</span>
            </motion.div>
            ...
            >
              Suburban living pressure washing specialists serving 
              <span className="text-accent font-semibold"> Westside Estates</span>, 
              <span className="text-accent font-semibold"> Westside Gardens</span>, 
              <span className="text-accent font-semibold"> Westside Park</span>, and 
              <span className="text-accent font-semibold"> Westside Residential</span>.
            </motion.p>
            ...
            >
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/25 hover:bg-white/20 transition-all duration-300">
                <div className="text-3xl md:text-4xl font-bold text-accent mb-2">34+ Years</div>
                <div className="text-white/90 text-sm md:text-base">Suburban Experience</div>
              </div>
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/25 hover:bg-white/20 transition-all duration-300">
                <div className="text-3xl md:text-4xl font-bold text-accent-eco mb-2">1100+</div>
                <div className="text-white/90 text-sm md:text-base">Westside Properties</div>
              </div>
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/25 hover:bg-white/20 transition-all duration-300">
                <div className="text-3xl md:text-4xl font-bold text-secondary mb-2">100%</div>
                <div className="text-white/90 text-sm md:text-base">Neighborhood Satisfaction</div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center space-x-3 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-full border border-white/25">
                <FaCheckCircle className="text-accent-eco text-lg" />
                <span className="font-semibold">Neighborhood Care</span>
              </div>
              <div className="flex items-center space-x-3 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-full border border-white/25">
                <FaCheckCircle className="text-accent-eco text-lg" />
            ...
            >
              <p className="text-white/80 text-sm mb-4">Trusted by Westside Residents for Over 34 Years</p>
              <div className="flex justify-center space-x-6 text-white/60">
                <span className="text-sm">✓ Licensed & Insured</span>
                <span className="text-sm">✓ Suburban Expertise</span>
                <span className="text-sm">✓ Neighborhood Focus</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-neutral-text mb-6">
              Westside Pressure Washing Excellence
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              As the trusted pressure washing company serving Westside, we understand the unique demands of this family-oriented suburban community. 
              Our neighborhood-focused approach combines professional service with the care and attention that Westside's residential properties deserve.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            >
              <h3 className="text-3xl font-bold text-neutral-text mb-6">
                Why Westside Needs Professional Pressure Washing
              </h3>
              <div className="space-y-4 text-lg text-gray-700">
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-accent rounded-full mt-3 flex-shrink-0"></div>
                  <p><strong>Suburban Environment:</strong> Westside's suburban setting exposes properties to pollen, dust, and seasonal weather that requires regular cleaning.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-accent rounded-full mt-3 flex-shrink-0"></div>
                  <p><strong>Family Safety:</strong> Westside's family-oriented community requires safe, eco-friendly cleaning that protects children, pets, and the environment.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-accent rounded-full mt-3 flex-shrink-0"></div>
                  <p><strong>Property Value:</strong> Regular maintenance helps preserve the value of Westside's well-maintained suburban properties.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-accent rounded-full mt-3 flex-shrink-0"></div>
                  <p><strong>Community Standards:</strong> Westside's family-friendly community requires service that maintains neighborhood beauty and safety.</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <h4 className="text-2xl font-bold mb-6">Westside Quick Facts</h4>
          ...
          >
            <h3 className="text-3xl font-bold text-neutral-text mb-8">
              Westside Service Areas We Cover
            </h3>
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-text mb-4">
              Why Choose Us for Westside
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Westside is Jacksonville's family-friendly suburban community, known for its safe neighborhoods, excellent schools, and residential charm. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600">
                Westside's suburban environment requires specialized approaches for residential properties.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-neutral-text mb-3">Neighborhood Care</h3>
              <p className="text-gray-600">
                We prioritize community standards and provide service that enhances neighborhood beauty.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-text mb-4">
              Our Westside Services
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Family-focused cleaning services for Westside's residential properties
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container-custom">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-neutral-text mb-6">
              What Westside Families Say
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Don't just take our word for it - hear from our satisfied Westside clients
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                rating: 5,
                text: "As Westside homeowners, we needed a pressure washing company that we could trust with our family. Jax FL Pressure Washing provided exceptional service while keeping our children and pets safe. Our home looks amazing!",
              ...
              },
              {
                ...
                rating: 5,
                text: "Our Westside home needed attention after a pollen season. The team was professional, family-friendly, and used safe cleaning techniques that protected our landscaping and family.",
              ...
              },
              {
                ...
                rating: 5,
                text: "Living in Westside means being part of a family community. These professionals understand that and provide service that meets our family's needs while maintaining the highest safety standards.",
      ...
      <section className="py-20 bg-gray-50">
        <div className="container-custom">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-neutral-text mb-6">
              Westside Pressure Washing FAQ
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Common questions about pressure washing services in Westside, Jacksonville
            </p>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            {[
              ...
              },
              {
                ...
                answer: "Absolutely! We take special care to protect Westside's landscaping during cleaning. We use landscape-safe techniques and cover delicate plants to ensure your gardens remain beautiful and unharmed."
              },
              {
                question: "What makes Westside properties different for pressure washing?",
                answer: "Westside's suburban environment, family-oriented community, and residential focus require specialized care. We understand the unique challenges of maintaining family homes while ensuring safety and community standards."
              },
              {
                question: "How long does a typical Westside home cleaning take?",
                answer: "Most Westside homes take 3-5 hours depending on size, landscaping complexity, and services needed. Family homes require extra care and attention to detail, which we factor into our timeline estimates."
              },
              {
                question: "Do you offer family-focused maintenance packages?",
                answer: "Yes! We offer specialized maintenance packages for Westside families, including regular cleaning schedules, family safety programs, and priority booking for residential properties."
              },
              {
                question: "What areas of my Westside property do you clean?",
        ...
        <div className="container-custom text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Ready to Protect Your Westside Family Home?
            </h2>
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Join our satisfied Westside families who trust us to maintain their beautiful homes safely.
            </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Jax FL Pressure Washing - Westside",
