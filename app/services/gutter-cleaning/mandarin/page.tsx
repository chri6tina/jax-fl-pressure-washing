    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative z-10 container mx-auto text-center text-white px-4">
          ...
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-shadow">
              Gutter Cleaning in Mandarin, Jacksonville
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100 text-shadow max-w-3xl mx-auto">
              Professional gutter cleaning services in Mandarin, FL. Transform your home's appearance with our eco-friendly technology.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
              Mandarin Gutter Cleaning - Professional Exterior Cleaning Services
            </h2>
            <p className="text-lg text-gray-600 mb-8">
              Looking for reliable gutter cleaning services in Mandarin, Jacksonville? Our professional team specializes in gutter cleaning that safely removes dirt, mold, mildew, and algae without damaging your home's exterior surfaces.
            </p>
          </motion.div>
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Mandarin Gutter Cleaning Services</h3>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
                  <FaCheckCircle className="mr-3 text-green-500 mt-1 flex-shrink-0" />
          ...
          >
            <h3 className="text-2xl font-bold mb-4">Mandarin Gutter Cleaning - Local SEO Focus</h3>
            <p className="text-lg mb-6">
              Serving Mandarin, Jacksonville Beach, Mandarin, and surrounding areas with professional gutter cleaning services. 
          ...
          >
            <motion.div variants={fadeInUp}>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Professional gutter cleaning services in Mandarin, Jacksonville. Keep your gutters flowing freely and protect your home from water damage with our thorough cleaning service.
              </p>
              <p className="text-lg text-gray-600 mb-8">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Mandarin Gutter Cleaning Benefits
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Mandarin's unique environment requires specialized gutter cleaning approaches. We understand the local challenges and provide solutions that work.
            </p>
          </motion.div>
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600">
                Professional gutter cleaning in Mandarin provides long-term benefits that protect your investment and maintain your property's value.
              </p>
            </motion.div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Our Mandarin Gutter Cleaning Process
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We follow a proven process to ensure your Mandarin home gets the best possible gutter cleaning service.
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Mandarin Gutter Cleaning Pricing
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 text-blue-100">
              Join hundreds of satisfied Mandarin homeowners who trust us with their gutter cleaning needs. Get your free quote today!
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Frequently Asked Questions - Mandarin Gutter Cleaning
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Get answers to common questions about gutter cleaning services in Mandarin, Jacksonville
            </p>
          </motion.div>
          ...
          >
            <motion.div variants={fadeInUp} className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-bold text-gray-800 mb-3">How often should I gutter clean my home in Mandarin?</h3>
              <p className="text-gray-600">
                Mandarin's humid subtropical climate means homes should be gutter cleaned every 6-12 months. This prevents mold, mildew, and algae buildup that's common in our area. For comprehensive protection, consider our <Link href="/services/preventative-maintenance" className="text-blue-600 hover:text-blue-700 underline">preventative maintenance services</Link>.
              </p>
            </motion.div>
      ...
      <section className="py-16 bg-blue-50">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
              Mandarin Gutter Cleaning - Your Local Pressure Washing Experts
            </h2>
            <p className="text-lg text-gray-600 mb-8">
              Serving Mandarin and surrounding Jacksonville communities with professional, reliable gutter cleaning services. 
