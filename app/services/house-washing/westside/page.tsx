...
const HouseWashingWestsidePage = () => {
  const fadeInUp = {
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative z-10 container mx-auto px-4 py-24 pt-32">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              House Washing in Westside, Jacksonville
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Professional house washing services in Westside, FL. Transform your property's appearance with our eco-friendly technology.
            </p>
          ...
          >
            <motion.div variants={fadeInUp}>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
                Professional House Washing in Westside
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                Westside property owners trust us for their house washing needs. Our technology safely removes dirt, stains, and contaminants without damaging your surfaces.
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Westside House Washing Benefits
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Westside's unique environment requires specialized house washing approaches. We understand the local challenges and provide solutions that work.
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Our Westside House Washing Process
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We follow a proven 5-step process to ensure your Westside property gets the best possible house washing service.
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Westside House Washing Pricing
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Join hundreds of satisfied Westside property owners who trust us with their house washing needs. Get your free quote today!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/contact"
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Professional house washing services in Westside, Florida",
                ...
                "itemListElement": [
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "House Washing in Westside",
                      "description": "Professional house washing services for Westside homes and businesses"
                    }
                  }
                ]
              },
...
export default HouseWashingWestsidePage