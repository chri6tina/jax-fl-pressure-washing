...
import { FaPhone, FaCheckCircle, FaStar, FaLeaf, FaShieldAlt, FaHome, FaWater, FaClock, FaUsers, FaAward, FaParking, FaLeaf as FaLeafIcon } from 'react-icons/fa'

const ParkingGarageCleaningPage = () => {
  const services = [
    {
      title: "Multi-Level Garage Cleaning",
      description: "Complete cleaning of multi-story parking structures and facilities",
      benefits: ["Safety compliance", "Professional appearance", "Customer satisfaction"]
    },
    {
      title: "Parking Structure Maintenance",
      description: "Professional cleaning and maintenance of parking facilities",
      benefits: ["Structural integrity", "Safety standards", "Long-term protection"]
    },
    {
      title: "Concrete Surface Cleaning",
      description: "Deep cleaning of concrete floors, walls, and support structures",
      benefits: ["Stain removal", "Surface restoration", "Safety improvement"]
    },
    {
      title: "Drainage System Cleaning",
      description: "Cleaning of drains, gutters, and water management systems",
      benefits: ["Flood prevention", "Structural protection", "Safety compliance"]
    },
    {
      title: "Parking Garage Maintenance Plans",
  ...
  const processSteps = [
    {
      ...
      description: "Professional evaluation of parking garage condition and cleaning requirements"
    },
    {
      step: 2,
      title: "Safety Planning",
      description: "Comprehensive safety protocols and traffic management planning"
    },
    {
      step: 3,
      title: "Area Preparation",
      description: "Protection of equipment and coordination with facility management"
    },
    {
      step: 4,
  ...
  const benefits = [
    {
      ...
      description: "Meet all safety and maintenance requirements for parking facilities"
    },
    {
      icon: FaShieldAlt,
      title: "Structural Protection",
      description: "Professional cleaning protects concrete and structural elements"
    },
    {
      icon: FaUsers,
      title: "Customer Satisfaction",
      description: "Clean, well-maintained parking facilities improve user experience"
    },
    {
      icon: FaHome,
      title: "Property Value",
      description: "Well-maintained parking structures command higher property values"
    },
    {
      icon: FaClock,
      title: "Minimal Disruption",
      description: "Efficient cleaning with minimal disruption to parking operations"
    },
    {
      icon: FaAward,
      title: "Industry Standards",
      description: "Meet or exceed industry standards for parking facility maintenance"
    }
  ]
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-32">
        ...
        <div className="relative z-10 container-custom text-center text-neutral-white px-4">
          ...
          >
            ...
            >
              <FaParking className="text-accent text-lg" />
              <span className="text-sm font-semibold">Parking Facility Specialists</span>
            </motion.div>
            ...
            >
              <span className="block">Parking Garage</span>
            ...
            >
              Professional parking garage cleaning services in Jacksonville, Florida. 
              <span className="text-accent font-semibold"> Ensure safety compliance, protect structural integrity,</span> and 
              maintain professional standards with our specialized parking facility cleaning services.
            </motion.p>
            ...
            >
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/25 hover:bg-white/20 transition-all duration-300">
                ...
                <div className="text-white/90 text-sm md:text-base">Parking Facility Experience</div>
              </div>
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/25 hover:bg-white/20 transition-all duration-300">
                <div className="text-3xl md:text-4xl font-bold text-accent-eco mb-2">75+</div>
                <div className="text-white/90 text-sm md:text-base">Garages Cleaned</div>
              </div>
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/25 hover:bg-white/20 transition-all duration-300">
            ...
            >
              ...
              <div className="flex items-center space-x-3 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-full border border-white/25">
                <FaCheckCircle className="text-accent-eco text-lg" />
                <span className="font-semibold">Structural Protection</span>
              </div>
              <div className="flex items-center space-x-3 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-full border border-white/25">
                <FaCheckCircle className="text-accent-eco text-lg" />
            ...
            >
              <Link href="/contact" className="btn-primary text-xl px-10 py-5 transform hover:scale-105 transition-all duration-300 shadow-2xl">
                Get Free Parking Facility Quote
              </Link>
            ...
            >
              <p className="text-white/80 text-sm mb-4">Trusted by Jacksonville Parking Facilities for Over 15 Years</p>
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-neutral-text mb-6">
              Complete Parking Facility Services
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Our specialized parking garage cleaning services focus on safety compliance, 
              structural protection, and professional appearance, ensuring your facility meets all standards.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              We follow a systematic approach to ensure your parking garage receives the highest quality 
              cleaning while maintaining safety standards and structural integrity.
            </p>
          </motion.div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              ...
              providing the highest quality parking facility care with the latest technology and proven results.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Get answers to the most common questions about our parking garage cleaning services.
            </p>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Most parking garages benefit from cleaning every 3-6 months, depending on traffic, 
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                off-peak hours to minimize disruption to parking operations and user experience.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                safety-certified and insured for parking facility work.
              </p>
            </motion.div>
            ...
            >
              <h3 className="text-xl font-bold text-neutral-text mb-4">
                Do you clean drainage systems?
              </h3>
              <p className="text-gray-600 leading-relaxed">
                Yes! We specialize in cleaning drainage systems including drains, gutters, and 
                water management systems. This is crucial for preventing flooding and protecting 
            ...
            >
              <h3 className="text-xl font-bold text-neutral-text mb-4">
                Do you offer maintenance plans for parking garages?
              </h3>
              <p className="text-gray-600 leading-relaxed">
        ...
        <div className="container-custom text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-neutral-white mb-6">
              Ready to Enhance Your Parking Facility?
            </h2>
            <p className="text-xl text-neutral-white/90 max-w-3xl mx-auto mb-8 leading-relaxed">
              Get your free estimate today and see the difference professional parking garage 
              cleaning can make. Our team is ready to boost your facility's safety and appearance.
            </p>
...
export default ParkingGarageCleaningPage
