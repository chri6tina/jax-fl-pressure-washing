...
import { FaPhone, FaCheckCircle, FaStar, FaLeaf, FaShieldAlt, FaHome, FaWater, FaClock, FaUsers, FaAward, FaUmbrellaBeach, FaLeaf as FaLeafIcon } from 'react-icons/fa'

const PatioCleaningPage = () => {
  const services = [
    {
      title: "Concrete Patio Cleaning",
      description: "Deep cleaning of concrete patios to remove stains, mold, and weather damage",
      benefits: ["Removes stains", "Restores beauty", "Extends life"]
    },
    {
      title: "Paver Patio Restoration",
      description: "Professional cleaning and sealing of paver patios for lasting beauty",
      benefits: ["Restores appearance", "Prevents staining", "Maintains value"]
    },
    {
      title: "Stone Patio Care",
      description: "Gentle cleaning of natural stone patios to preserve their natural beauty",
      benefits: ["Preserves stone", "Maintains color", "Prevents damage"]
    },
    {
      title: "Patio Sealing Services",
      description: "Protective sealing to prevent weather damage and maintain surface integrity",
      benefits: ["Weather protection", "Prevents staining", "Easier maintenance"]
    },
    {
      title: "Patio Inspection & Repair",
      description: "Professional assessment and repair of patio damage and safety issues",
      benefits: ["Identifies problems", "Prevents accidents", "Saves money"]
    }
  ]
  ...
  const processSteps = [
    {
      ...
      description: "Professional evaluation of patio condition and cleaning requirements"
    },
    {
      step: 2,
      title: "Area Preparation",
      description: "Protection of landscaping, furniture, and sensitive areas before cleaning"
    },
    {
      step: 3,
      title: "Stain Treatment",
      description: "Application of specialized solutions to break down stubborn stains and growth"
    },
    {
      step: 4,
      title: "Deep Cleaning",
      description: "High-pressure cleaning to remove all debris, stains, and weather damage"
    },
    {
      step: 5,
      title: "Surface Restoration",
      description: "Treatment to restore original appearance and prepare for sealing"
    },
    {
      step: 6,
      title: "Protective Sealing",
      description: "Application of weather-resistant sealant for long-term protection"
    }
  ]
  ...
  const benefits = [
    {
      ...
      description: "Transform your patio into a beautiful, welcoming outdoor living space"
    },
    {
      icon: FaLeaf,
      title: "Eco-Friendly",
      description: "Safe cleaning methods that won't harm your landscaping or family"
    },
    {
      icon: FaHome,
      title: "Increased Value",
      description: "Well-maintained patios significantly increase your property's curb appeal"
    },
    {
      icon: FaWater,
    ...
    },
    {
      icon: FaClock,
      title: "Quick Service",
      description: "Most patio cleaning projects completed in 3-4 hours"
    },
    {
      icon: FaUsers,
      title: "Family Safe",
      description: "Non-toxic solutions safe for children, pets, and outdoor entertaining"
    }
  ]
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-32">
        ...
        <div className="relative z-10 container-custom text-center text-neutral-white px-4">
          ...
          >
            ...
            >
              <FaUmbrellaBeach className="text-accent text-lg" />
              <span className="text-sm font-semibold">Outdoor Living Specialists</span>
            </motion.div>
            ...
            >
              <span className="block">Patio</span>
            ...
            >
              Professional patio cleaning services in Jacksonville, Florida. 
              <span className="text-accent font-semibold"> Restore beauty, enhance outdoor living,</span> and 
              protect your investment with our specialized cleaning and sealing services.
            </motion.p>
            ...
            >
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/25 hover:bg-white/20 transition-all duration-300">
                ...
                <div className="text-white/90 text-sm md:text-base">Outdoor Living Experience</div>
              </div>
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/25 hover:bg-white/20 transition-all duration-300">
                <div className="text-3xl md:text-4xl font-bold text-accent-eco mb-2">800+</div>
                <div className="text-white/90 text-sm md:text-base">Patios Transformed</div>
              </div>
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/25 hover:bg-white/20 transition-all duration-300">
            ...
            >
              ...
              <div className="flex items-center space-x-3 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-full border border-white/25">
                <FaCheckCircle className="text-accent-eco text-lg" />
                <span className="font-semibold">Weather Protection</span>
              </div>
              <div className="flex items-center space-x-3 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-full border border-white/25">
                <FaCheckCircle className="text-accent-eco text-lg" />
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-neutral-text mb-6">
              Complete Patio Care Services
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Our specialized patio cleaning services focus on beauty, durability, and outdoor living 
              enhancement, ensuring your patio remains both attractive and functional year-round.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              We follow a systematic approach to ensure your patio receives the highest quality 
              cleaning while protecting your landscaping and outdoor living spaces.
            </p>
          </motion.div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              ...
              providing the highest quality patio care with the latest technology and proven results.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Get answers to the most common questions about our patio cleaning services.
            </p>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Most patios benefit from cleaning every 1-2 years, depending on usage, climate, and 
                the presence of trees or landscaping. High-traffic areas and humid climates like 
            ...
            >
              <h3 className="text-xl font-bold text-neutral-text mb-4">
                Can you remove oil stains from my patio?
              </h3>
              <p className="text-gray-600 leading-relaxed">
                Yes! We use specialized oil stain removal techniques and products that can effectively 
                remove even the most stubborn oil stains from patio surfaces. Our process penetrates 
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Most patio cleaning projects are completed in 3-4 hours, depending on size, condition, 
                and whether sealing is included. We work efficiently to minimize disruption to your 
                outdoor living routine.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                protection against weather damage, UV rays, and staining. Sealing also makes future 
                cleaning easier and extends the life of your patio.
              </p>
            </motion.div>
            ...
            >
              <h3 className="text-xl font-bold text-neutral-text mb-4">
                What types of patio materials can you clean?
              </h3>
              <p className="text-gray-600 leading-relaxed">
                We clean all types of patio materials including concrete, pavers, natural stone, 
                brick, and composite materials. Each material requires specific cleaning techniques 
        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <p className="text-xl text-neutral-white/90 max-w-3xl mx-auto mb-8 leading-relaxed">
              Get your free estimate today and see the difference professional patio cleaning can make. 
              Our team is ready to restore beauty and enhance your outdoor living space.
            </p>
