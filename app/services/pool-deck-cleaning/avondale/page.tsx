...
const PoolDeckCleaningAvondalePage = () => {
  const fadeInUp = {
        ...
        <div className="relative z-10 container mx-auto text-center text-white px-4">
          ...
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-shadow">
              Pool Deck Cleaning in Avondale, Jacksonville
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100 text-shadow max-w-3xl mx-auto">
              Professional pool deck cleaning services in Avondale, FL. Transform your outdoor living space with our expert cleaning solutions.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
              Avondale Pool Deck Cleaning - Professional Outdoor Living Space Services
            </h2>
            <p className="text-lg text-gray-600 mb-8">
              Looking for reliable pool deck cleaning services in Avondale, Jacksonville? Our professional team specializes in outdoor living space cleaning that safely restores and maintains your outdoor areas.
            </p>
          </motion.div>
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Avondale Pool Deck Cleaning Services</h3>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
                  <FaCheckCircle className="mr-3 text-green-500 mt-1 flex-shrink-0" />
          ...
          >
            <h3 className="text-2xl font-bold mb-4">Avondale Pool Deck Cleaning - Local SEO Focus</h3>
            <p className="text-lg mb-6">
              Serving Avondale, Jacksonville Beach, Mandarin, and surrounding areas with professional pool deck cleaning services. 
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <motion.div variants={fadeInUp}>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
                Professional Pool Deck Cleaning in Avondale
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                Avondale homeowners trust us for their pool deck cleaning needs. Our technology safely restores and maintains your outdoor living spaces without damaging surfaces.
              </p>
              <p className="text-lg text-gray-600 mb-8">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 text-blue-100">
              Join hundreds of satisfied Avondale homeowners who trust us with their pool deck cleaning needs. Get your free quote today!
            </p>
...
export default PoolDeckCleaningAvondalePage