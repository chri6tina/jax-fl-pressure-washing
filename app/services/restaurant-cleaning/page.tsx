...
import { FaPhone, FaCheckCircle, FaStar, FaLeaf, FaShieldAlt, FaHome, FaWater, FaClock, FaUsers, FaAward, FaUtensils, FaLeaf as FaLeafIcon } from 'react-icons/fa'

const RestaurantCleaningPage = () => {
  const services = [
    {
      title: "Restaurant Exterior Cleaning",
      description: "Complete exterior cleaning of restaurant buildings and facades",
      benefits: ["Health compliance", "Customer attraction", "Professional image"]
    },
    {
      title: "Kitchen Exhaust Cleaning",
      description: "Professional cleaning of kitchen exhaust systems and hoods",
      benefits: ["Fire safety", "Health compliance", "Equipment longevity"]
    },
    {
      title: "Outdoor Dining Areas",
      description: "Cleaning of patios, decks, and outdoor seating areas",
      benefits: ["Customer comfort", "Safety compliance", "Enhanced dining"]
    },
    {
      title: "Restaurant Signage Cleaning",
      description: "Professional cleaning of restaurant signs and branding elements",
      benefits: ["Brand visibility", "Professional appearance", "Customer attraction"]
    },
    {
      title: "Restaurant Maintenance Plans",
  ...
  const processSteps = [
    {
      ...
      description: "Professional evaluation of restaurant condition and cleaning requirements"
    },
    {
      step: 2,
      title: "Health Code Review",
      description: "Understanding of health department requirements and compliance needs"
    },
    {
      step: 3,
      title: "Business Coordination",
      description: "Coordination with restaurant staff to minimize disruption"
    },
    {
      step: 4,
      title: "Specialized Cleaning",
      description: "Application of food-safe cleaning methods for each area"
    },
    {
      step: 5,
  ...
  const benefits = [
    {
      ...
      description: "Meet all health department requirements for restaurant cleanliness"
    },
    {
      icon: FaStar,
      title: "Customer Attraction",
      description: "Clean, attractive exteriors draw more customers to your restaurant"
    },
    {
      icon: FaShieldAlt,
      title: "Fire Safety",
      description: "Professional kitchen exhaust cleaning prevents fire hazards"
    },
    {
      icon: FaHome,
      title: "Professional Image",
      description: "Well-maintained restaurants command higher customer satisfaction"
    },
    {
      icon: FaClock,
      title: "Minimal Disruption",
      description: "Efficient cleaning with minimal disruption to restaurant operations"
    },
    {
      icon: FaAward,
      title: "Industry Standards",
      description: "Meet or exceed industry standards for restaurant maintenance"
    }
  ]
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-32">
        ...
        <div className="relative z-10 container-custom text-center text-neutral-white px-4">
          ...
          >
            ...
            >
              <FaUtensils className="text-accent text-lg" />
              <span className="text-sm font-semibold">Restaurant Specialists</span>
            </motion.div>
            ...
            >
              Professional restaurant cleaning services in Jacksonville, Florida. 
              <span className="text-accent font-semibold"> Ensure health compliance, enhance customer attraction,</span> and 
              maintain professional standards with our specialized restaurant cleaning services.
            </motion.p>
            ...
            >
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/25 hover:bg-white/20 transition-all duration-300">
                ...
                <div className="text-white/90 text-sm md:text-base">Restaurant Experience</div>
              </div>
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/25 hover:bg-white/20 transition-all duration-300">
                <div className="text-3xl md:text-4xl font-bold text-accent-eco mb-2">300+</div>
                <div className="text-white/90 text-sm md:text-base">Restaurants Served</div>
              </div>
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/25 hover:bg-white/20 transition-all duration-300">
                <div className="text-3xl md:text-4xl font-bold text-secondary mb-2">100%</div>
                <div className="text-white/90 text-sm md:text-base">Health Compliance</div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center space-x-3 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-full border border-white/25">
                <FaCheckCircle className="text-accent-eco text-lg" />
                <span className="font-semibold">Customer Attraction</span>
              </div>
              <div className="flex items-center space-x-3 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-full border border-white/25">
                <FaCheckCircle className="text-accent-eco text-lg" />
            ...
            >
              <p className="text-white/80 text-sm mb-4">Trusted by Jacksonville Restaurants for Over 15 Years</p>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Our specialized restaurant cleaning services focus on health compliance, 
              fire safety, and customer attraction, ensuring your restaurant meets all standards.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              We follow a systematic approach to ensure your restaurant receives the highest quality 
              cleaning while maintaining health compliance and business operations.
            </p>
          </motion.div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              ...
              providing the highest quality restaurant care with the latest technology and proven results.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Get answers to the most common questions about our restaurant cleaning services.
            </p>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            >
              <h3 className="text-xl font-bold text-neutral-text mb-4">
                How often should restaurants be cleaned?
              </h3>
              <p className="text-gray-600 leading-relaxed">
                Most restaurants benefit from cleaning every 1-3 months, depending on traffic, 
            ...
            >
              <h3 className="text-xl font-bold text-neutral-text mb-4">
                Do you clean kitchen exhaust systems?
              </h3>
              <p className="text-gray-600 leading-relaxed">
                Yes! We specialize in kitchen exhaust cleaning which is crucial for fire safety 
                and health compliance. Our process removes grease buildup that can cause fire 
                hazards and health code violations.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                off-peak hours to minimize disruption to restaurant operations and customer experience.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                kitchen exhaust cleaning, and outdoor dining area maintenance. We provide 
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                kitchen exhaust maintenance, and priority scheduling. This helps maintain 
                compliance and can reduce overall maintenance costs.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container-custom text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-neutral-white mb-6">
              Ready to Enhance Your Restaurant?
            </h2>
            <p className="text-xl text-neutral-white/90 max-w-3xl mx-auto mb-8 leading-relaxed">
              Get your free estimate today and see the difference professional restaurant 
              cleaning can make. Our team is ready to boost your hospitality success.
            </p>
