...
const RoofCleaningMandarinPage = () => {
  const fadeInUp = {
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative z-10 container mx-auto text-center text-white px-4">
          ...
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-shadow">
              Roof Cleaning in Mandarin, Jacksonville
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100 text-shadow max-w-3xl mx-auto">
              Professional roof cleaning services in Mandarin, FL. Transform your home's appearance with our eco-friendly technology.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
              Mandarin Roof Cleaning - Professional Exterior Cleaning Services
            </h2>
            <p className="text-lg text-gray-600 mb-8">
              Looking for reliable roof cleaning services in Mandarin, Jacksonville? Our professional team specializes in roof cleaning that safely removes dirt, mold, mildew, and algae without damaging your home's exterior surfaces.
            </p>
          </motion.div>
          ...
          >
            <motion.div variants={fadeInUp} className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Why Mandarin Homeowners Choose Us</h3>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
                  <FaCheckCircle className="mr-3 text-green-500 mt-1 flex-shrink-0" />
                  <span><strong>Local Expertise:</strong> Serving Mandarin since 2019 with deep knowledge of local climate challenges</span>
                </li>
                <li className="flex items-start">
                  <FaCheckCircle className="mr-3 text-green-500 mt-1 flex-shrink-0" />
                  <span><strong>Eco-Friendly Solutions:</strong> Safe for your family, pets, and Mandarin's beautiful landscaping</span>
                </li>
                <li className="flex items-start">
                  <FaCheckCircle className="mr-3 text-green-500 mt-1 flex-shrink-0" />
                  <span><strong>Proven Results:</strong> Hundreds of satisfied Mandarin homeowners trust us year after year</span>
                </li>
                <li className="flex items-start">
                  <FaCheckCircle className="mr-3 text-green-500 mt-1 flex-shrink-0" />
                  <span><strong>Same-Day Service:</strong> Quick response times for Mandarin's busy families</span>
                </li>
              </ul>
            </motion.div>

            <motion.div variants={fadeInUp} className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Mandarin Roof Cleaning Services</h3>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
                  <FaCheckCircle className="mr-3 text-green-500 mt-1 flex-shrink-0" />
                ...
                <li className="flex items-start">
                  <FaCheckCircle className="mr-3 text-green-500 mt-1 flex-shrink-0" />
                  <span><strong>Mold & Mildew Removal:</strong> Combat Mandarin's humid climate challenges</span>
                </li>
                <li className="flex items-start">
                  <FaCheckCircle className="mr-3 text-green-500 mt-1 flex-shrink-0" />
                  <span><strong>Eco-Friendly Cleaning:</strong> Safe solutions for your Mandarin home</span>
                </li>
                <li className="flex items-start">
                  <FaCheckCircle className="mr-3 text-green-500 mt-1 flex-shrink-0" />
          ...
          >
            <h3 className="text-2xl font-bold mb-4">Mandarin Roof Cleaning - Local SEO Focus</h3>
            <p className="text-lg mb-6">
              Serving Mandarin, Jacksonville Beach, Mandarin, and surrounding areas with professional roof cleaning services. 
              Our Mandarin location expertise ensures the best results for your home.
            </p>
            <div className="grid md:grid-cols-3 gap-6 text-sm">
              <div>
                <strong>Service Areas:</strong> Mandarin, Jacksonville Beach, Mandarin, San Marco
              </div>
              <div>
                <strong>Specialties:</strong> Roof Cleaning, Mold removal, Eco-friendly cleaning
              </div>
              <div>
                <strong>Experience:</strong> 5+ years serving Mandarin homeowners
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Related Services in Mandarin</h3>
              <p className="text-gray-600 mb-6">
                While you're here, explore our other professional cleaning services available in Mandarin:
              </p>
            ...
            <motion.div variants={fadeInUp} className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Mandarin Service Coverage</h3>
              <p className="text-gray-600 mb-6">
                We provide comprehensive cleaning services throughout Mandarin and surrounding Jacksonville areas:
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <motion.div variants={fadeInUp}>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
                Professional Roof Cleaning in Mandarin
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                Professional roof cleaning services in Mandarin, Jacksonville. Our safe, low-pressure cleaning methods remove algae, moss, and debris without damaging your roof shingles.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                Serving Mandarin and surrounding areas with eco-friendly cleaning solutions that protect your family, pets, and landscaping while delivering exceptional results.
              </p>
              <div className="flex items-center text-blue-600 font-semibold">
                <FaMapMarkerAlt className="mr-2" />
                <span>Serving Mandarin, Jacksonville, FL</span>
              </div>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Mandarin Roof Cleaning Benefits
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Mandarin's unique environment requires specialized roof cleaning approaches. We understand the local challenges and provide solutions that work.
            </p>
          </motion.div>
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600">
                Professional roof cleaning in Mandarin provides long-term benefits that protect your investment and maintain your property's value.
              </p>
            </motion.div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Our Mandarin Roof Cleaning Process
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We follow a proven process to ensure your Mandarin home gets the best possible roof cleaning service.
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Mandarin Roof Cleaning Pricing
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Competitive pricing for Mandarin homeowners. Get a free quote today!
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Ready to Transform Your Mandarin Home?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Join hundreds of satisfied Mandarin homeowners who trust us with their roof cleaning needs. Get your free quote today!
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Frequently Asked Questions - Mandarin Roof Cleaning
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Get answers to common questions about roof cleaning services in Mandarin, Jacksonville
            </p>
          </motion.div>
          ...
          >
            <motion.div variants={fadeInUp} className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-bold text-gray-800 mb-3">How often should I roof clean my home in Mandarin?</h3>
              <p className="text-gray-600">
                Mandarin's humid subtropical climate means homes should be roof cleaned every 6-12 months. This prevents mold, mildew, and algae buildup that's common in our area. For comprehensive protection, consider our <Link href="/services/preventative-maintenance" className="text-blue-600 hover:text-blue-700 underline">preventative maintenance services</Link>.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-bold text-gray-800 mb-3">Do you serve all of Mandarin?</h3>
              <p className="text-gray-600">
                Yes! We serve all Mandarin neighborhoods and surrounding areas. We also cover nearby communities like Jacksonville Beach, Mandarin, and San Marco. Check our <Link href="/locations" className="text-blue-600 hover:text-blue-700 underline">locations page</Link> for complete coverage details.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Most Mandarin homes take 2-4 hours depending on size and condition. We work efficiently to minimize disruption to your daily routine. For urgent needs, we offer <Link href="/services/emergency-services" className="text-blue-600 hover:text-blue-700 underline">emergency cleaning services</Link>.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Absolutely! We use eco-friendly solutions that are safe for your family, pets, and Mandarin's beautiful landscaping. We also take precautions to protect your plants during cleaning. Learn more about our <Link href="/services/eco-friendly-solutions" className="text-blue-600 hover:text-blue-700 underline">eco-friendly approach</Link>.
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section className="py-16 bg-blue-50">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
              Mandarin Roof Cleaning - Your Local Pressure Washing Experts
            </h2>
            <p className="text-lg text-gray-600 mb-8">
              Serving Mandarin and surrounding Jacksonville communities with professional, reliable roof cleaning services. 
              Our local expertise and commitment to quality make us the preferred choice for Mandarin homeowners.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 text-left">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li>• Mandarin & surrounding areas</li>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li>• Mandarin-based business since 2019</li>
                  <li>• Deep knowledge of local climate challenges</li>
                  <li>• Quick response times for Mandarin residents</li>
...
export default RoofCleaningMandarinPage