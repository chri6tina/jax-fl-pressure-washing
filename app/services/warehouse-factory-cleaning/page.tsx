...
import { FaPhone, FaCheckCircle, FaStar, FaLeaf, FaShieldAlt, FaHome, FaWater, FaClock, FaUsers, FaAward, FaIndustry, FaLeaf as FaLeafIcon } from 'react-icons/fa'

const WarehouseFactoryCleaningPage = () => {
  const services = [
    {
      title: "Warehouse Exterior Cleaning",
      description: "Complete exterior cleaning of warehouse buildings and facilities",
      benefits: ["Professional appearance", "Safety compliance", "Equipment protection"]
    },
    {
      title: "Factory Building Maintenance",
      description: "Professional cleaning and maintenance of industrial facilities",
      benefits: ["Operational efficiency", "Safety standards", "Equipment longevity"]
    },
    {
      title: "Industrial Equipment Cleaning",
      description: "Cleaning of exterior equipment and machinery surfaces",
      benefits: ["Equipment protection", "Operational safety", "Maintenance efficiency"]
    },
    {
      title: "Loading Dock Cleaning",
      description: "Professional cleaning of loading areas and dock facilities",
      benefits: ["Safety compliance", "Professional appearance", "Operational efficiency"]
    },
    {
      title: "Industrial Maintenance Plans",
  ...
  const processSteps = [
    {
      ...
      description: "Professional evaluation of warehouse/factory condition and cleaning requirements"
    },
    {
      step: 2,
      title: "Safety Planning",
      description: "Comprehensive safety protocols and equipment preparation for industrial work"
    },
    {
      step: 3,
      title: "Equipment Protection",
      description: "Protection of sensitive equipment and operational areas before cleaning"
    },
    {
      step: 4,
      title: "Specialized Cleaning",
      description: "Application of industrial-grade cleaning methods for each surface type"
    },
    {
      step: 5,
  ...
  const benefits = [
    {
      ...
      description: "Clean facilities improve operational efficiency and equipment performance"
    },
    {
      icon: FaShieldAlt,
      title: "Safety Compliance",
      description: "Meet all safety and maintenance requirements for industrial properties"
    },
    {
      icon: FaUsers,
      title: "Employee Safety",
      description: "Clean, well-maintained facilities improve employee safety and satisfaction"
    },
    {
      icon: FaHome,
      title: "Professional Image",
      description: "Well-maintained industrial facilities command higher property values"
    },
    {
      icon: FaClock,
      title: "Minimal Disruption",
      description: "Efficient cleaning with minimal disruption to industrial operations"
    },
    {
      icon: FaAward,
      title: "Industry Standards",
      description: "Meet or exceed industry standards for industrial facility maintenance"
    }
  ]
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-32">
        ...
        <div className="relative z-10 container-custom text-center text-neutral-white px-4">
          ...
          >
            ...
            >
              <FaIndustry className="text-accent text-lg" />
              <span className="text-sm font-semibold">Industrial Specialists</span>
            </motion.div>
            ...
            >
              <span className="block">Warehouse & Factory</span>
            ...
            >
              Professional warehouse and factory cleaning services in Jacksonville, Florida. 
              <span className="text-accent font-semibold"> Improve operational efficiency, ensure safety compliance,</span> and 
              maintain professional standards with our specialized industrial cleaning services.
            </motion.p>
            ...
            >
              ...
              <div className="flex items-center space-x-3 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-full border border-white/25">
                <FaCheckCircle className="text-accent-eco text-lg" />
                <span className="font-semibold">Equipment Protection</span>
              </div>
              <div className="flex items-center space-x-3 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-full border border-white/25">
                <FaCheckCircle className="text-accent-eco text-lg" />
            ...
            >
              <p className="text-white/80 text-sm mb-4">Trusted by Jacksonville Industrial Facilities for Over 15 Years</p>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Our specialized warehouse and factory cleaning services focus on operational efficiency, 
              safety compliance, and equipment protection, ensuring your facility meets all standards.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              We follow a systematic approach to ensure your industrial facility receives the highest quality 
              cleaning while maintaining safety standards and operational efficiency.
            </p>
          </motion.div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              ...
              providing the highest quality industrial facility care with the latest technology and proven results.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Get answers to the most common questions about our warehouse and factory cleaning services.
            </p>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Most industrial facilities benefit from cleaning every 3-6 months, depending on operations, 
            ...
            >
              <h3 className="text-xl font-bold text-neutral-text mb-4">
                Can you clean during operations?
              </h3>
              <p className="text-gray-600 leading-relaxed">
                Yes! We offer flexible scheduling including after-hours, weekends, and shutdown periods 
                to minimize disruption to industrial operations. We can also work around your 
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                safety-certified and insured for industrial work.
              </p>
            </motion.div>
            ...
            >
              <h3 className="text-xl font-bold text-neutral-text mb-4">
                Do you clean industrial equipment?
              </h3>
              <p className="text-gray-600 leading-relaxed">
                Yes! We specialize in cleaning exterior equipment and machinery surfaces. Our 
                process removes dirt, grime, and buildup that can affect equipment performance 
                and safety.
              </p>
            </motion.div>
            ...
            >
              <h3 className="text-xl font-bold text-neutral-text mb-4">
                Do you offer maintenance plans for industrial facilities?
              </h3>
              <p className="text-gray-600 leading-relaxed">
        ...
        <div className="container-custom text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-neutral-white mb-6">
              Ready to Enhance Your Industrial Facility?
            </h2>
            <p className="text-xl text-neutral-white/90 max-w-3xl mx-auto mb-8 leading-relaxed">
              Get your free estimate today and see the difference professional industrial facility 
              cleaning can make. Our team is ready to boost your operational efficiency.
            </p>
...
export default WarehouseFactoryCleaningPage
